                    ...
                    if (isReplyToSentMsg) {
                        ...
                        if (messageType === '1' || messageType === '2') {
                            ...
                            if (messageType === '1') {
                                ...
                                await conn.sendMessage(from, { audio: { url: downloadUrl }, mimetype: "audio/mpeg", caption: `> ʙʜᴀꜱʜɪ ᴍᴅ ᴠᴇʀꜱɪᴏɴ 2.0.0
> ꜱɪᴍᴘʟᴇ ᴡᴀ ʙᴏᴛ ᴍᴀᴅᴇ ʙʏ ʙʜᴀꜱʜɪ ᴄᴏᴅᴇʀꜱ ㋛` }, { quoted: mek });
                                ...
                                await conn.sendMessage(from, {
                                    ...
                                    caption: `> ʙʜᴀꜱʜɪ ᴍᴅ ᴠᴇʀꜱɪᴏɴ 2.0.0
> ꜱɪᴍᴘʟᴇ ᴡᴀ ʙᴏᴛ ᴍᴀᴅᴇ ʙʏ ʙʜᴀꜱʜɪ ᴄᴏᴅᴇʀꜱ ㋛`
                                }, { quoted: mek });
                            }
                ...
                conn.ev.on('messages.upsert', async (messageUpdate) => {
                    ...
                    if (isReplyToSentMsg) {
                        ...
                        if (messageType === '1' || messageType === '2') {
                            ...
                            if (messageType === '1') {
                                // Handle option 1 (Audio File)
                                await conn.sendMessage(from, { video: { url: downloadUrl }, mimetype: "video/mp4", caption: `> ʙʜᴀꜱʜɪ ᴍᴅ ᴠᴇʀꜱɪᴏɴ 2.0.0
> ꜱɪᴍᴘʟᴇ ᴡᴀ ʙᴏᴛ ᴍᴀᴅᴇ ʙʏ ʙʜᴀꜱʜɪ ᴄᴏᴅᴇʀꜱ ㋛` }, { quoted: mek });
                            } else if (messageType === '2') {
                                // Handle option 2 (Document File)
                                await conn.sendMessage(from, {
